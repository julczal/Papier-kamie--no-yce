...
var possibleChoicesSrc = ['./images/icon-paper.svg', './images/icon-scissors.svg', './images/icon-rock.svg']
var finalScore = 0;
...
function game (){
    ...
    aiChoice = possibleChoices[Math.floor(Math.random() * possibleChoices.length)]


    var playerChoiceSrc = '';
    var aiChoiceSrc = '';
    if(playerChoice == possibleChoices[0]){
        playerChoiceSrc = possibleChoicesSrc[0]
    }else if(playerChoice == possibleChoices[1]){
        playerChoiceSrc = possibleChoicesSrc[1]
    }else{
        playerChoiceSrc = possibleChoicesSrc[2]
    };
    
    if(aiChoice == possibleChoices[0]){
        aiChoiceSrc = possibleChoicesSrc[0]
    }else if(aiChoice == possibleChoices[1]){
        aiChoiceSrc = possibleChoicesSrc[1]
    }else{
        aiChoiceSrc = possibleChoicesSrc[2]
    }; 
...
resultCreate()
    ...
    //sprawdza jaki wynik przegrana/wygrana/remis
